  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        <p className="topbar-title"><strong className="topbar-brand"><img src="/favicon.svg" alt="" aria-hidden="true" /><span>AG FOR ALL</span></strong><span> — See How RAG Works, Step by Step.</span></p>
