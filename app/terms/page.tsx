...
export const metadata: Metadata = {
  ...
  description: "Public-beta terms for using RAG FOR ALL.",
  openGraph: { title: "Terms — RAG FOR ALL", description: "Public-beta terms for using RAG FOR ALL.", images: [] },
  twitter: { title: "Terms — RAG FOR ALL", description: "Public-beta terms for using RAG FOR ALL.", images: [] },
};
...
export default function TermsPage() {
  return <LegalPage
    ...
    introduction="RAG FOR ALL is an experimental learning product, not a production decision system. By using the public beta, you agree to the terms below."
    sections={[
      { title: "What this beta is for", paragraphs: ["The service helps visitors understand, visualize, and compare a Retrieval-Augmented Generation pipeline. Features, limits, availability, and stored records may change while the product is being tested."] },
      ...
      { title: "Access and availability", paragraphs: ["The public site may pause model-backed features, reduce limits, or become temporarily unavailable to protect the service, control cost, investigate misuse, or end the beta. The service is provided as available without a promise of uninterrupted operation or permanent storage."] },
      ...
      { title: "Changes", paragraphs: ["These terms may be updated as the public beta changes. Continued use after an update means you accept the revised terms."] },
    ]}
  />;
}
